...
def process_a():
    ...
    print('Method process_a, value: ', ti.xcom_pull(key = 'pet_name', task_ids = 'extract_names_xcom_push_disabled', dag_id = 'my_dag'))
    print('Method process_a, value: ', ti.xcom_pull(key = 'pet_type', task_ids = 'extract_names_xcom_push_disabled', dag_id = 'my_dag'))

@task.python
def process_b():
    ti = get_current_context()['ti']
    print('Method process_b, value: ', ti.xcom_pull(key = 'pet_name', task_ids = 'extract_names_xcom_push_disabled', dag_id = 'my_dag'))
    print('Method process_b, value: ', ti.xcom_pull(key = 'pet_type', task_ids = 'extract_names_xcom_push_disabled', dag_id = 'my_dag'))

@task.python
def process_c():
    ti = get_current_context()['ti']
    print('Method process_c, value: ', ti.xcom_pull(key = 'pet_name', task_ids = 'extract_names_xcom_push_disabled', dag_id = 'my_dag'))
    print('Method process_c, value: ', ti.xcom_pull(key = 'pet_type', task_ids = 'extract_names_xcom_push_disabled', dag_id = 'my_dag'))
